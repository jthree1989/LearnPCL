...
main (int argc, char *argv[])
{
  ...
  writer.write<pcl::PointXYZ> (pcd_file+"_filtered.pcd", *cloud_filtered, false);
  
  
  PointCloud2Vector3d (cloud_filtered, data.interior);
  pcl::visualization::PointCloudColorHandlerCustom<Point> handler (cloud_filtered, 0, 255, 0);
  viewer.addPointCloud<Point> (cloud_filtered, handler, "cloud_cylinder");
